    ...
    <div name='book' className="search">
      <div className="container">
        <div className="left">
          ...
          <p>
            Come experience he very pinnacle of luxury Carribean all-inclusive
            vacations for couples at Sandals Resorts. Our luxury beach resorts,
            set along the most gorgeous tropical settings and exquisite beaches
            in Saint Lucia, Jamaica, Antigua, The Bahamas, Grenada, Barbados and
            Curacoa, feature unlimited gourmet dining, unique bars serving
            ...
            is the leader in Carribean destination weddings and honeymoon
            packages.
          </p>
        ...
        <div className="right">
          <div className="promo">
            <h4 className="save">GET AN ADITIONAL 7% OFF!</h4>
